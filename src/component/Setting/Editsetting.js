...
function Editsetting() {
    ...
    const {
      ...
      const viewSettingOneClose = () => {
        setSettingOneEdit(false);
      }

      const handleSettingChange = (e) => {
        setValuesFive({
          settingDanger: e.target.value
        });
      };
      ...
      const handleSubmitSetting = () => {
        const updatedDataSet = {
          settingId: 1,
          settingDanger: valuesFive.settingDanger
        };
        updateOneSetting(1, updatedDataSet);
      };
...
<div className="setting-control-div">
      ...
      <div className='setting-comp-div'>
        ...
        <div className="todo-danger">
            <div className='todo-danger-view'>
              <form action="/setting" onSubmit={handleSubmitSetting}>
                ...
                <input
                  ...
                  name="setting-danger"
                  autoComplete="off"
                  placeholder="Yeni değer belirle!"
                  type="number"
                  onChange={handleSettingChange}
                  value={valuesFive?.settingDanger}
                />
                </div>

                <div className="button-input">
                  <button className='stock-alert-update-button' role="button" type="submit">Güncelle</button>

                  <Link to="/setting"><button className='todo-setting-close-button'>Kapat</button></Link>
